...
def get_model():
    model=BertForSequenceClassification.from_pretrained("Lavya1107/bert_model_for_college_admission")
    tokenizer= BertTokenizerFast.from_pretrained("Lavya1107/bert_model_for_college_admission")
